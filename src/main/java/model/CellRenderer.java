    ...
    public ListCell<Conversation> call(ListView<Conversation> param) {
        ...
        ListCell<Conversation> cell = new ListCell<Conversation>() {
            ...
            protected void updateItem(Conversation convo, boolean empty) {
                ...
                setGraphic(null);
                setText(null);
                //load multiple cell.fxml file - using for each conversation
                if (convo != null) {
        ...
        cell.addEventFilter(MouseEvent.MOUSE_CLICKED, event -> {
            if (event.getButton() == MouseButton.PRIMARY && (!cell.isEmpty())) {
                ...
                if (convo_selected != convo.getId_convo()) {
                    ...
                    LoginUIController.clientUIController.loadSelectedConvo(convo);
                    LoginUIController.clientUIController.displaySelectedConvo(convo);
                    //System.out.println(ClientUIController.convo_type);
                }
            }
        });
